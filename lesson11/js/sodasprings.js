    ...
    .then(function(jsonObject) {
        ...
        for (let i = 0; i < towns.length; i++) {
            if (i == 5) {
                ...
                document.querySelector('section.sodaEvents').appendChild(card);
            }
        }
    });

//CURRENT WEATHER SUMMARY
const apiURLcurrent = "//api.openweathermap.org/data/2.5/weather?id=5607916&appid=d22907017fd3e32a422553d0e2603101&units=imperial";
...
//FORECAST WEATHER
const apiUrlforecast = "//api.openweathermap.org/data/2.5/forecast?id=5607916&appid=d22907017fd3e32a422553d0e2603101&units=imperial";
    ...
    .then((forecastInfo) => {
        ...
        for (i=0; i<mylist.length; i++) {
            ...
            if(time.includes('18:00:00')) {
                ...
                document.getElementById('sweatherforecast').appendChild(theDay);
            }
        }
    });